...
public class MaintMark : MonoBehaviour, ITrackableEventHandler
{
    ...
    private bool mShowGUIButton2 = true;
    private Rect mButtonRect2 = new Rect(0,1820, 1200, 111);
    ...
    public void OnTrackableStateChanged(TrackableBehaviour.Status previousStatus, TrackableBehaviour.Status newStatus)
    {
        if (newStatus == TrackableBehaviour.Status.DETECTED || newStatus == TrackableBehaviour.Status.TRACKED)
        {
            ...
            //Application.OpenURL("http://192.168.217.179:1880");
        }
        //else if (previousStatus == TrackableBehaviour.Status.TRACKED && newStatus == TrackableBehaviour.Status.)
        //{
    ...
    void OnGUI()
    {
        ...
        {
            // draw the GUI button
            if (GUI.Button(mButtonRect, "Close"))
            {
                CloseWebViewTapped();
        ...
        else if (mShowGUIButton2)
            {
                // draw the GUI button
                if (GUI.Button(mButtonRect2, "Retroceder"))
                {
